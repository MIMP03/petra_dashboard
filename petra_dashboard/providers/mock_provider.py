"""
Proveedor MOCK: simula un robot moviéndose dentro del mapa de referencia,
con batería bajando lentamente, temperatura fluctuando, cámara que a veces
"falla" para poder ver cómo se comportan las alertas del dashboard.
...
class MockProvider(BaseProvider):
    ...
    def get_photos(self):
        ...
        # Cuando conectes la cámara real, el ROS provider llenará esto.
        return []
    ...
    def _simulate_step(self, dt):
        # Movimiento hacia la meta, si existe
        if self._goal:
            ...
            if dist < 0.05:
                ...
                # moverse consume batería un poco más rápido
                self._battery_pct -= 0.03

        # Batería baja lentamente con el tiempo (standby) y se recarga
        # sola al llegar a 15% para poder ver el ciclo completo en la demo.
        ...
        # Temperatura fluctúa alrededor de una media, sube un poco si se mueve
        ...
        # poder probar la alerta "cámara no enciende", y se recupera sola.
